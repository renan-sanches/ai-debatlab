 ...
 * Custom avatars with personality names
 */
...
/**
 * Get avatar for a model, with fallback
 * @param modelId - Model ID
 * @param modelAvatars - Avatar assignments from debate
 * @returns Avatar path or fallback URL
 */
export function getModelAvatar(
    modelId: string,
